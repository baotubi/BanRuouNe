...
namespace QLBRUOU.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="RuouPhule")]
    ...
    partial void DeleteRUOU(RUOU instance);
		...
		public dbQLBANRUOUDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["RuouPhuleConnectionString2"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class LIENHE : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _DiaChiLH;
		
		private string _SDThoai;
		
		private string _TNhan;
    ...
    partial void OnDiaChiLHChanging(string value);
    partial void OnDiaChiLHChanged();
    partial void OnSDThoaiChanging(string value);
    partial void OnSDThoaiChanged();
    partial void OnTNhanChanging(string value);
    partial void OnTNhanChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DiaChiLH", DbType="NVarChar(100)")]
		public string DiaChiLH
		{
			get
			{
				return this._DiaChiLH;
			}
			set
			{
				if ((this._DiaChiLH != value))
				{
					this.OnDiaChiLHChanging(value);
					this.SendPropertyChanging();
					this._DiaChiLH = value;
					this.SendPropertyChanged("DiaChiLH");
					this.OnDiaChiLHChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SDThoai", DbType="NChar(15)")]
		public string SDThoai
		{
			get
			{
				return this._SDThoai;
			}
			set
			{
				if ((this._SDThoai != value))
				{
					this.OnSDThoaiChanging(value);
					this.SendPropertyChanging();
					this._SDThoai = value;
					this.SendPropertyChanged("SDThoai");
					this.OnSDThoaiChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TNhan", DbType="NVarChar(200)")]
		public string TNhan
		{
			get
			{
			...
			set
			{
				if ((this._TNhan != value))
				{
					this.OnTNhanChanging(value);
					this.SendPropertyChanging();
					this._TNhan = value;
					this.SendPropertyChanged("TNhan");
					this.OnTNhanChanged();
				}
			}
		}
